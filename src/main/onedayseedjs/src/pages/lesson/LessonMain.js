          ...
          <section className='lessonMainForm'>
            <div style={{textAlign: "center"}} >
              <b>
                ...
                <button className='classPlusBtn'><Link to="/lesson/new" className="w-btn-green btn" type="button" id='classPlusBtn-word'>클래스 등록</Link></button>
              </b>
            </div>
            {lessons && lessons.length > 0 ? (
                ...
                <h1 style={{textAlign: "center", fontSize:"16px"}}>등록한 클래스가 없습니다.</h1>
            )}<br />
          </section>
        </BasicLayout>
      </div>
